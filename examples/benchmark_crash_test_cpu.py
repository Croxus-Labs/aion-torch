"""Benchmark crash test: AION vs Standard Transformer on extreme depth (CPU).
...
Usage:
    python examples/benchmark_crash_test_cpu.py

Output:
    - crash_test_data_cpu.csv: Training history (loss, gradients)
...
LEARNING_RATE = 1e-3
GRAD_CLIP_NORM = 10.0
NUM_SEEDS = 5  # Increased for statistical significance
...
def save_csv_data(
    ...
    csv_path = output_dir / "crash_test_data_cpu.csv"
...
def main():
    ...
    try:
        ...
        print("=" * 80)
        print("\nResults saved to:")
        print("  - examples/outputs/crash_test_data_cpu.csv")
        print("\nBenchmark complete.")
